...
class Organizacao(Base):
    ...
    notificacoes = relationship("Notificacao", back_populates="organizacao")
...
class Maquina(Base):
    """Modelo de maquina monitorada na rede."""
...
class Notificacao(Base):
    """Modelo de notificacao de sistema para o usuario."""
    ...
    # Relacionamentos
    organizacao = relationship("Organizacao", back_populates="notificacoes")
    usuario = relationship("User", back_populates="notificacoes")
    chamado = relationship("Chamado")


class VisualizacaoChamado(Base):
    """Modelo para registrar quando um usuario visualiza um chamado (Tracking para views do Admin)."""
    __tablename__ = "visualizacoes_chamado"
    ...
    visualizado_em = Column(DateTime, default=datetime.utcnow)

    # Relacionamentos
    chamado = relationship("Chamado", back_populates="visualizacoes")
    usuario = relationship("User", back_populates="visualizacoes")
